...
<v-container fluid>
    ...
    <v-row align="center">
        <v-col class="d-flex" cols="12" sm="6">
            ...
            <v-select :items="userList1" v-model="userName" label="Select a Service user" variant="outlined">
    ...
    <v-row align="center" justify="space-around">
        <v-col class="d-flex" cols="12" sm="6">
            <v-btn @click="clearAll"  prepend-icon="mdi-plus">CLEAR ALL</v-btn>
        </v-col>
        <v-col class="d-flex" cols="12" sm="6">
...
export default {
    ...
    methods: {
        ...
        updateData(){
            ...
            this.$router.push({ name: 'viewjob', params: { id: this.userName } })
        }
    }
}
</script>
